...
{ label: "Broadsword", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Agility", range: "Melee", damage: "d8", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Longsword", tier: 1, magic: false, pages: ["CRB 115"], errata: true, trait: "Agility", range: "Melee", damage: "d10+3", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Battleaxe", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Strength", range: "Melee", damage: "d10+3", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Greatsword", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Strength", range: "Melee", damage: "d10+3", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Massive:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>; on a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Mace", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Strength", range: "Melee", damage: "d8+1", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Warhammer", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Strength", range: "Melee", damage: "d12+3", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Dagger", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+1", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Quarterstaff", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Instinct", range: "Melee", damage: "d10+3", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Cutlass", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Presence", range: "Melee", damage: "d8+1", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Rapier", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Presence", range: "Melee", damage: "d8", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Halberd", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Strength", range: "Very Close", damage: "d10+2", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Cumbersome:</em></strong> &minus;1 to <a href='#define-finesse'>Finesse</a>" },
{ label: "Spear", tier: 1, magic: false, pages: ["CRB 115"], errata: true, trait: "Finesse", range: "Very Close", damage: "d8+3", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Shortbow", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Agility", range: "Far", damage: "d6+3", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Crossbow", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Finesse", range: "Far", damage: "d6+1", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Longbow", tier: 1, magic: false, pages: ["CRB 115"], errata: false, trait: "Agility", range: "Very Far", damage: "d8+3", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Cumbersome:</em></strong> &minus;1 to <a href='#define-finesse'>Finesse</a>" },
{ label: "Arcane Gauntlets", tier: 1, magic: true, pages: ["CRB 115"], errata: false, trait: "Strength", range: "Melee", damage: "d10+3", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Hallowed Axe", tier: 1, magic: true, pages: ["CRB 115"], errata: false, trait: "Strength", range: "Melee", damage: "d8+1", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Glowing Rings", tier: 1, magic: true, pages: ["CRB 115"], errata: true, trait: "Agility", range: "Very Close", damage: "d10+2", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Hand Runes", tier: 1, magic: true, pages: ["CRB 115"], errata: false, trait: "Instinct", range: "Very Close", damage: "d10", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Returning Blade", tier: 1, magic: true, pages: ["CRB 115"], errata: false, trait: "Finesse", range: "Close", damage: "d8", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Returning:</em></strong> When this <a href='#define-weapon'>weapon</a> is <a href='#define-weapon'>thrown</a> within its <a href='#define-range'>range</a>, it appears in your hand immediately after the attack." },
{ label: "Shortstaff", tier: 1, magic: true, pages: ["CRB 115"], errata: false, trait: "Instinct", range: "Close", damage: "d8+1", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Dualstaff", tier: 1, magic: true, pages: ["CRB 115"], errata: false, trait: "Instinct", range: "Far", damage: "d6+3", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Scepter", tier: 1, magic: true, pages: ["CRB 115"], errata: false, trait: "Presence", range: "Far", damage: "d6", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Versatile:</em></strong> This <a href='#define-weapon'>weapon</a> can also be used with these statistics&mdash;Presence, Melee, d8." },
{ label: "Wand", tier: 1, magic: true, pages: ["CRB 115"], errata: false, trait: "Knowledge", range: "Far", damage: "d6+1", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Greatstaff", tier: 1, magic: true, pages: ["CRB 115"], errata: false, trait: "Knowledge", range: "Very Far", damage: "d6", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Improved Broadsword", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Agility", range: "Melee", damage: "d8+3", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Improved Longsword", tier: 2, magic: false, pages: ["CRB 116"], errata: true, trait: "Agility", range: "Melee", damage: "d10+6", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Improved Battleaxe", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Strength", range: "Melee", damage: "d10+6", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Improved Greatsword", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Strength", range: "Melee", damage: "d10+6", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Massive:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>; on a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Improved Mace", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Strength", range: "Melee", damage: "d8+4", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Improved Warhammer", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Strength", range: "Melee", damage: "d12+6", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Improved Dagger", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+4", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Improved Quarterstaff", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Instinct", range: "Melee", damage: "d10+6", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Improved Cutlass", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Presence", range: "Melee", damage: "d8+4", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Improved Rapier", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Presence", range: "Melee", damage: "d8+3", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Improved Halberd", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Strength", range: "Very Close", damage: "d10+5", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Cumbersome:</em></strong> &minus;1 to <a href='#define-finesse'>Finesse</a>" },
{ label: "Improved Spear", tier: 2, magic: false, pages: ["CRB 116"], errata: true, trait: "Finesse", range: "Very Close", damage: "d8+6", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Improved Shortbow", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Agility", range: "Far", damage: "d6+6", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Improved Crossbow", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Finesse", range: "Far", damage: "d6+4", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Improved Longbow", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Agility", range: "Very Far", damage: "d8+6", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Cumbersome:</em></strong> &minus;1 to <a href='#define-finesse'>Finesse</a>" },
{ label: "Gilded Falchion", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Strength", range: "Melee", damage: "d10+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Knuckle Blades", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Strength", range: "Melee", damage: "d10+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Brutal:</em></strong> When you roll the maximum value on a <a href='#define-damage-roll'>damage die</a>, roll an additional <a href='#define-damage-roll'>damage die</a>." },
{ label: "Urok Broadsword", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+3", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Deadly:</em></strong> When you deal <a href='#define-hit-point'>Severe</a> damage, the target must mark an additional <a href='#define-hit-point'>Hit Point</a>." },
{ label: "Bladed Whip", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Agility", range: "Very Close", damage: "d8+3", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Steelforged Halberd", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Strength", range: "Very Close", damage: "d8+4", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Scary:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, the target must mark a <a href='#define-stress'>Stress</a>." },
{ label: "War Scythe", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Finesse", range: "Very Close", damage: "d8+5", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Blunderbuss", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Finesse", range: "Close", damage: "d8+6", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Reloading:</em></strong> After you make an <a href='#define-attack-roll'>attack</a>, roll a <strong>d6</strong>. On a result of 1, you must mark a <a href='#define-stress'>Stress</a> to reload this <a href='#define-weapon'>weapon</a> before you can fire it again." },
{ label: "Greatbow", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Strength", range: "Far", damage: "d6+6", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Finehair Bow", tier: 2, magic: false, pages: ["CRB 116"], errata: false, trait: "Agility", range: "Very Far", damage: "d6+5", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Improved Arcane Gauntlets", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Strength", range: "Melee", damage: "d10+6", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Improved Hallowed Axe", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Strength", range: "Melee", damage: "d8+4", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Improved Glowing Rings", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Agility", range: "Very Close", damage: "d10+5", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Improved Hand Runes", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Instinct", range: "Very Close", damage: "d10+3", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Improved Returning Blade", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Finesse", range: "Close", damage: "d8+3", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Returning:</em></strong> When this <a href='#define-weapon'>weapon</a> is <a href='#define-weapon'>thrown</a> within its <a href='#define-range'>range</a>, it appears in your hand immediately after the attack." },
{ label: "Improved Shortstaff", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Instinct", range: "Close", damage: "d8+4", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Improved Dualstaff", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Instinct", range: "Far", damage: "d6+6", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Improved Scepter", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Presence", range: "Far", damage: "d6+3", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Versatile:</em></strong> This <a href='#define-weapon'>weapon</a> can also be used with these statistics&mdash;Presence, Melee, d8+3." },
{ label: "Improved Wand", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Knowledge", range: "Far", damage: "d6+4", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Improved Greatstaff", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Knowledge", range: "Very Far", damage: "d6+3", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Ego Blade", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Agility", range: "Melee", damage: "d12+4", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Pompous:</em></strong> You must have a <a href='#define-presence'>Presence</a> of 0 or lower to use this <a href='#define-weapon'>weapon</a>." },
{ label: "Casting Sword", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Strength", range: "Melee", damage: "d10+4", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Versatile:</em></strong> This <a href='#define-weapon'>weapon</a> can also be used with these statistics&mdash;Knowledge, Far, d6+3." },
{ label: "Devouring Dagger", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+4", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Scary:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, the target must mark a <a href='#define-stress'>Stress</a>." },
{ label: "Hammer of Exota", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Instinct", range: "Melee", damage: "d8+6", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Eruptive:</em></strong> On a successful attack against a target within <a href='#define-range'>Melee</a> range, all other adversaries within <a href='#define-range'>Very Close</a> range must succeed on a <a href='#define-reaction-roll'>Reaction Roll</a> (14) or take half damage." },
{ label: "Yutari Bloodbow", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Finesse", range: "Far", damage: "d6+4", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Brutal:</em></strong> When you roll the maximum value on a <a href='#define-damage-roll'>damage die</a>, roll an additional <a href='#define-damage-roll'>damage die</a>." },
{ label: "Elder Bow", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Instinct", range: "Far", damage: "d6+4", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Scepter of Elias", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Presence", range: "Far", damage: "d6+3", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Invigorating:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll a <strong>d4</strong>. On a result of 4, clear a <a href='#define-stress'>Stress</a>." },
{ label: "Wand of Enthrallment", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Presence", range: "Far", damage: "d6+4", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Persuasive:</em></strong> Before you make a <a href='#define-trait-roll'>Presence Roll</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to gain a +2 bonus to the result." },
{ label: "Keeper's Staff", tier: 2, magic: true, pages: ["CRB 117"], errata: false, trait: "Knowledge", range: "Far", damage: "d6+4", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Advanced Broadsword", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Agility", range: "Melee", damage: "d8+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Advanced Longsword", tier: 3, magic: false, pages: ["CRB 118"], errata: true, trait: "Agility", range: "Melee", damage: "d10+9", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Advanced Battleaxe", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Strength", range: "Melee", damage: "d10+9", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Advanced Greatsword", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Strength", range: "Melee", damage: "d10+9", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Massive:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>; on a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Advanced Mace", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Strength", range: "Melee", damage: "d8+7", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Advanced Warhammer", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Strength", range: "Melee", damage: "d12+9", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Advanced Dagger", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+7", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Advanced Quarterstaff", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Instinct", range: "Melee", damage: "d10+9", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Advanced Cutlass", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Presence", range: "Melee", damage: "d8+7", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Advanced Rapier", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Presence", range: "Melee", damage: "d8+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Advanced Halberd", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Strength", range: "Very Close", damage: "d10+8", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Cumbersome:</em></strong> &minus;1 to <a href='#define-finesse'>Finesse</a>" },
{ label: "Advanced Spear", tier: 3, magic: false, pages: ["CRB 118"], errata: true, trait: "Finesse", range: "Very Close", damage: "d8+9", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Advanced Shortbow", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Agility", range: "Far", damage: "d6+9", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Advanced Crossbow", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Finesse", range: "Far", damage: "d6+7", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Advanced Longbow", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Agility", range: "Very Far", damage: "d8+9", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Cumbersome:</em></strong> &minus;1 to <a href='#define-finesse'>Finesse</a>" },
{ label: "Flickerfly Blade", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Agility", range: "Melee", damage: "d8+5", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Sharpening:</em></strong> Gain a bonus to your <a href='#define-damage-roll'>damage rolls</a> equal to your <a href='#define-agility'>Agility</a>." },
{ label: "Bravesword", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Strength", range: "Melee", damage: "d12+7", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Brave:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>; +3 to Severe <a href='#define-hit-point'>damage threshold</a>" },
{ label: "Hammer of Wrath", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Strength", range: "Melee", damage: "d10+7", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Devastating:</em></strong> Before you make an <a href='#define-attack-roll'>attack roll</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to use a <strong>d20</strong> as your <a href='#define-damage-roll'>damage die</a>." },
{ label: "Labrys Axe", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Strength", range: "Melee", damage: "d10+7", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Protective:</em></strong> +1 to <a href='#define-armor'>Armor Score</a>" },
{ label: "Meridian Cutlass", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Presence", range: "Melee", damage: "d10+5", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Dueling:</em></strong> When there are no other creatures within <a href='#define-range'>Close</a> range of the target, gain advantage on your <a href='#define-attack-roll'>attack roll</a> against them." },
{ label: "Retractable Saber", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Presence", range: "Melee", damage: "d10+7", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Retractable:</em></strong> The blade can be hidden in the hilt to avoid detection." },
{ label: "Double Flail", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Agility", range: "Very Close", damage: "d10+8", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Talon Blades", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Finesse", range: "Close", damage: "d10+7", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Brutal:</em></strong> When you roll the maximum value on a <a href='#define-damage-roll'>damage die</a>, roll an additional <a href='#define-damage-roll'>damage die</a>." },
{ label: "Black Powder Revolver", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Finesse", range: "Far", damage: "d6+8", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Reloading:</em></strong> After you make an <a href='#define-attack-roll'>attack</a>, roll a <strong>d6</strong>. On a result of 1, you must mark a <a href='#define-stress'>Stress</a> to reload this <a href='#define-weapon'>weapon</a> before you can fire it again." },
{ label: "Spiked Bow", tier: 3, magic: false, pages: ["CRB 118"], errata: false, trait: "Agility", range: "Very Far", damage: "d6+7", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Versatile:</em></strong> This <a href='#define-weapon'>weapon</a> can also be used with these statistics&mdash;Agility, Melee, d10+5." },
{ label: "Advanced Arcane Gauntlets", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Strength", range: "Melee", damage: "d10+9", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Advanced Hallowed Axe", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Strength", range: "Melee", damage: "d8+7", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Advanced Glowing Rings", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Agility", range: "Very Close", damage: "d10+8", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Advanced Hand Runes", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Instinct", range: "Very Close", damage: "d10+6", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Advanced Returning Blade", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Finesse", range: "Close", damage: "d8+6", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Returning:</em></strong> When this <a href='#define-weapon'>weapon</a> is <a href='#define-weapon'>thrown</a> within its <a href='#define-range'>range</a>, it appears in your hand immediately after the attack." },
{ label: "Advanced Shortstaff", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Instinct", range: "Close", damage: "d8+7", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Advanced Dualstaff", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Instinct", range: "Far", damage: "d6+9", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Advanced Scepter", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Presence", range: "Far", damage: "d6+6", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Versatile:</em></strong> This <a href='#define-weapon'>weapon</a> can also be used with these statistics&mdash;Presence, Melee, d8+4." },
{ label: "Advanced Wand", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Knowledge", range: "Far", damage: "d6+7", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Advanced Greatstaff", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Knowledge", range: "Very Far", damage: "d6+6", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Axe of Fortunis", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Strength", range: "Melee", damage: "d10+8", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Lucky:</em></strong> On a failed <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to <a href='#define-reroll'>reroll</a> your attack." },
{ label: "Blessed Anlace", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Instinct", range: "Melee", damage: "d10+6", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Healing:</em></strong> During <a href='#define-downtime'>downtime</a>, automatically clear a <a href='#define-hit-point'>Hit Point</a>." },
{ label: "Ghostblade", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Presence", range: "Melee", damage: "d10+7 phy or", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Otherworldly:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, you can deal <a href='#define-damage-type'>physical or magic damage</a>." },
{ label: "Runes of Ruination", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Knowledge", range: "Very Close", damage: "d20+4", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Painful:</em></strong> Each time you make a successful <a href='#define-attack-roll'>attack</a>, you must mark a <a href='#define-stress'>Stress</a>." },
{ label: "Widogast Pendant", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Knowledge", range: "Close", damage: "d10+5", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Timebending:</em></strong> You choose the target of your attack after making your <a href='#define-attack-roll'>attack roll</a>." },
{ label: "Gilded Bow", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Finesse", range: "Far", damage: "d6+7", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Self-Correcting:</em></strong> When you roll a 1 on a <a href='#define-damage-roll'>damage die</a>, it deals 6 damage instead." },
{ label: "Firestaff", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Instinct", range: "Far", damage: "d6+7", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Burning:</em></strong> When you roll a 6 on a <a href='#define-damage-roll'>damage die</a>, the target must mark a <a href='#define-stress'>Stress</a>." },
{ label: "Mage Orb", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Knowledge", range: "Far", damage: "d6+7", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Ilmari's Rifle", tier: 3, magic: true, pages: ["CRB 119"], errata: false, trait: "Finesse", range: "Very Far", damage: "d6+6", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Reloading:</em></strong> After you make an <a href='#define-attack-roll'>attack</a>, roll a d6. On a result of 1, you must mark a <a href='#define-stress'>Stress</a> to reload this weapon before you can fire it again." },
{ label: "Legendary Broadsword", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Agility", range: "Melee", damage: "d8+9", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Legendary Longsword", tier: 4, magic: false, pages: ["CRB 120"], errata: true, trait: "Agility", range: "Melee", damage: "d10+12", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Legendary Battleaxe", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Strength", range: "Melee", damage: "d10+12", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Legendary Greatsword", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Strength", range: "Melee", damage: "d10+12", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Massive:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>; on a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Legendary Mace", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Strength", range: "Melee", damage: "d8+10", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Legendary Warhammer", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Strength", range: "Melee", damage: "d12+12", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Legendary Dagger", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+10", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Legendary Quarterstaff", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Instinct", range: "Melee", damage: "d10+12", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Legendary Cutlass", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Presence", range: "Melee", damage: "d8+10", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Legendary Rapier", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Presence", range: "Melee", damage: "d8+9", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Legendary Halberd", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Strength", range: "Very Close", damage: "d10+11", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Cumbersome:</em></strong> &minus;1 to <a href='#define-finesse'>Finesse</a>" },
{ label: "Legendary Spear", tier: 4, magic: false, pages: ["CRB 120"], errata: true, trait: "Finesse", range: "Very Close", damage: "d8+12", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Legendary Shortbow", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Agility", range: "Far", damage: "d6+12", damagetype: "phy", burden: "Two-Handed", feature: "" },
{ label: "Legendary Crossbow", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Finesse", range: "Far", damage: "d6+10", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Legendary Longbow", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Agility", range: "Very Far", damage: "d8+12", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Cumbersome:</em></strong> &minus;1 to <a href='#define-finesse'>Finesse</a>" },
{ label: "Dual-Ended Sword", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Agility", range: "Melee", damage: "d10+9", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Impact Gauntlet", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Strength", range: "Melee", damage: "d10+11", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Concussive:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-hope'>spend a Hope</a></strong> to knock the target back to <a href='#define-range'>Far</a> range." },
{ label: "Sledge Axe", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Strength", range: "Melee", damage: "d12+13", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Destructive:</em></strong> &minus;1 to <a href='#define-agility'>Agility</a>; on a successful <a href='#define-attack-roll'>attack</a>, all adversaries within <a href='#define-range'>Very Close</a> range must mark a <a href='#define-stress'>Stress</a>." },
{ label: "Curved Dagger", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+9", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Serrated:</em></strong> When you roll a 1 on a <a href='#define-damage-roll'>damage die</a>, it deals 8 damage instead." },
{ label: "Extended Polearm", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Finesse", range: "Very Close", damage: "d8+10", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Long:</em></strong> This weapon's <a href='#define-attack-roll'>attack</a> targets all <a href='#define-adversary'>adversaries</a> in a line within <a href='#define-range'>range</a>." },
{ label: "Swinging Ropeblade", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Presence", range: "Close", damage: "d8+9", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Grappling:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-hope'>spend a Hope</a></strong> to <a href='#define-condition'><em>Restrain</em></a> the target or pull them into <a href='#define-range'>Melee</a> range with you." },
{ label: "Ricochet Axes", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Agility", range: "Far", damage: "d6+11", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Bouncing:</em></strong> Mark 1 or more <a href='#define-stress'>Stress</a> to hit that many targets in <a href='#define-range'>range</a> of the <a href='#define-attack-roll'>attack</a>." },
{ label: "Aantari Bow", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Finesse", range: "Far", damage: "d6+11", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Hand Cannon", tier: 4, magic: false, pages: ["CRB 120"], errata: false, trait: "Finesse", range: "Very Far", damage: "d6+12", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Reloading:</em></strong> After you make an <a href='#define-attack-roll'>attack</a>, roll a <strong>d6</strong>. On a 1, you must mark <a href='#define-stress'>Stress</a> to reload this <a href='#define-weapon'>weapon</a> before you can fire it again." },
{ label: "Legendary Arcane Gauntlets", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Strength", range: "Melee", damage: "d10+12", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Legendary Hallowed Axe", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Strength", range: "Melee", damage: "d8+10", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Legendary Glowing Rings", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Agility", range: "Very Close", damage: "d10+11", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Legendary Hand Runes", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Instinct", range: "Very Close", damage: "d10+9", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Legendary Returning Blade", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Finesse", range: "Close", damage: "d8+9", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Returning:</em></strong> When this <a href='#define-weapon'>weapon</a> is <a href='#define-weapon'>thrown</a> within its <a href='#define-range'>range</a>, it appears in your hand immediately after the attack." },
{ label: "Legendary Shortstaff", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Instinct", range: "Close", damage: "d8+10", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Legendary Dualstaff", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Instinct", range: "Far", damage: "d8+12", damagetype: "mag", burden: "Two-Handed", feature: "" },
{ label: "Legendary Scepter", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Presence", range: "Far", damage: "d6+9", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Versatile:</em></strong> This <a href='#define-weapon'>weapon</a> can also be used with these statistics&mdash;Presence, Melee, d8+6." },
{ label: "Legendary Wand", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Knowledge", range: "Far", damage: "d6+10", damagetype: "mag", burden: "One-Handed", feature: "" },
{ label: "Legendary Greatstaff", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Knowledge", range: "Very Far", damage: "d6+9", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Sword of Light and Flame", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Strength", range: "Melee", damage: "d10+11", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Hot:</em></strong> This <a href='#define-weapon'>weapon</a> cuts through solid material." },
{ label: "Siphoning Gauntlets", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Presence", range: "Melee", damage: "d10+9", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Lifestealing:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll a <strong>d6</strong>. On a result of 6, clear a <a href='#define-hit-point'>Hit Point</a> or clear a <a href='#define-stress'>Stress</a>." },
{ label: "Midas Scythe", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Knowledge", range: "Melee", damage: "d10+9", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Greedy:</em></strong> Spend a handful of <a href='#define-gold'>gold</a> to gain a +1 bonus to your <a href='#define-damage-roll'>Proficiency</a> on a <a href='#define-damage-roll'>damage roll</a>." },
{ label: "Floating Bladeshards", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Instinct", range: "Close", damage: "d8+9", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Bloodstaff", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Instinct", range: "Far", damage: "d20+7", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Painful:</em></strong> Each time you make a successful attack, you must mark a <a href='#define-stress'>Stress</a>." },
{ label: "Thistlebow", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Instinct", range: "Far", damage: "d6+13", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Wand of Essek", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Knowledge", range: "Far", damage: "d8+13", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Timebending:</em></strong> You can choose the target of your attack after making your attack roll." },
{ label: "Magus Revolver", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Finesse", range: "Very Far", damage: "d6+13", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Reloading:</em></strong> After you make an <a href='#define-attack-roll'>attack</a>, roll a <strong>d6</strong>. On a result of 1, you must mark a <a href='#define-stress'>Stress</a> to reload this <a href='#define-weapon'>weapon</a> before you can fire it again." },
{ label: "Fusion Gloves", tier: 4, magic: true, pages: ["CRB 121"], errata: false, trait: "Knowledge", range: "Very Far", damage: "d6+9", damagetype: "mag", burden: "Two-Handed", feature: "<strong><em>Bonded:</em></strong> Gain a bonus to your <a href='#define-damage-roll'>damage rolls</a> equal to your <a href='#define-level'>level</a>." },
{ label: "Light-Frame Wheelchair", tier: 1, magic: false, pages: ["CRB 123"], errata: false, trait: "Agility", range: "Melee", damage: "d8", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Improved Light-Frame Wheelchair", tier: 2, magic: false, pages: ["CRB 123"], errata: false, trait: "Agility", range: "Melee", damage: "d8+3", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Advanced Light-Frame Wheelchair", tier: 3, magic: false, pages: ["CRB 123"], errata: false, trait: "Agility", range: "Melee", damage: "d8+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Legendary Light-Frame Wheelchair", tier: 4, magic: false, pages: ["CRB 123"], errata: false, trait: "Agility", range: "Melee", damage: "d8+9", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Quick:</em></strong> When you make an <a href='#define-attack-roll'>attack</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to target another creature within <a href='#define-range'>range</a>." },
{ label: "Heavy-Frame Wheelchair", tier: 1, magic: false, pages: ["CRB 123"], errata: false, trait: "Strength", range: "Melee", damage: "d12+3", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Improved Heavy-Frame Wheelchair", tier: 2, magic: false, pages: ["CRB 123"], errata: false, trait: "Strength", range: "Melee", damage: "d12+6", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Advanced Heavy-Frame Wheelchair", tier: 3, magic: false, pages: ["CRB 123"], errata: false, trait: "Strength", range: "Melee", damage: "d12+9", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Legendary Heavy-Frame Wheelchair", tier: 4, magic: false, pages: ["CRB 123"], errata: false, trait: "Strength", range: "Melee", damage: "d12+12", damagetype: "phy", burden: "Two-Handed", feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Arcane-Frame Wheelchair", tier: 1, magic: true, pages: ["CRB 123"], errata: false, trait: "Spellcast", range: "Far", damage: "d6", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Improved Arcane-Frame Wheelchair", tier: 2, magic: true, pages: ["CRB 123"], errata: false, trait: "Spellcast", range: "Far", damage: "d6+3", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Advanced Arcane-Frame Wheelchair", tier: 3, magic: true, pages: ["CRB 123"], errata: false, trait: "Spellcast", range: "Far", damage: "d6+6", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" },
{ label: "Legendary Arcane-Frame Wheelchair", tier: 4, magic: true, pages: ["CRB 123"], errata: false, trait: "Spellcast", range: "Far", damage: "d6+9", damagetype: "mag", burden: "One-Handed", feature: "<strong><em>Reliable:</em></strong> +1 to <a href='#define-attack-roll'>attack rolls</a>" }
];
// weapons, secondary
const weaponsecondaryList = [
{ label: "Shortsword", tier: 1, pages: ["CRB 124"], errata: false, trait: "Agility", range: "Melee", damage: "d8", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Paired:</em></strong> +2 to <a href='#define-weapon'>primary weapon</a> damage to targets within <a href='#define-range'>Melee</a> range" },
{ label: "Round Shield", tier: 1, pages: ["CRB 124"], errata: false, trait: "Strength", range: "Melee", damage: "d4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Protective:</em></strong> +1 to <a href='#define-armor'>Armor Score</a>" },
{ label: "Tower Shield", tier: 1, pages: ["CRB 124"], errata: false, trait: "Strength", range: "Melee", damage: "d6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Barrier:</em></strong> +2 to <a href='#define-armor'>Armor Score</a>; &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Small Dagger", tier: 1, pages: ["CRB 124"], errata: false, trait: "Finesse", range: "Melee", damage: "d8", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Paired:</em></strong> +2 to <a href='#define-weapon'>primary weapon</a> damage to targets within <a href='#define-range'>Melee</a> range" },
{ label: "Whip", tier: 1, pages: ["CRB 124"], errata: false, trait: "Presence", range: "Very Close", damage: "d6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Startling:</em></strong> <strong><a href='#define-stress'>Mark a Stress</a></strong> to crack the whip and force all <a href='#define-adversary'>adversaries</a> within <a href='#define-range'>Melee</a> range back to <a href='#define-range'>Close</a> range." },
{ label: "Grappler", tier: 1, pages: ["CRB 124"], errata: false, trait: "Finesse", range: "Close", damage: "d6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Hooked:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, you can pull the target into <a href='#define-range'>Melee</a> range." },
{ label: "Hand Crossbow", tier: 1, pages: ["CRB 124"], errata: false, trait: "Finesse", range: "Far", damage: "d6+1", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Improved Shortsword", tier: 2, pages: ["CRB 124"], errata: false, trait: "Agility", range: "Melee", damage: "d8+2", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Paired:</em></strong> +3 to <a href='#define-weapon'>primary weapon</a> damage to targets within <a href='#define-range'>Melee</a> range" },
{ label: "Improved Round Shield", tier: 2, pages: ["CRB 124"], errata: false, trait: "Strength", range: "Melee", damage: "d4+2", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Protective:</em></strong> +2 to <a href='#define-armor'>Armor Score</a>" },
{ label: "Improved Tower Shield", tier: 2, pages: ["CRB 124"], errata: false, trait: "Strength", range: "Melee", damage: "d6+2", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Barrier:</em></strong> +3 to <a href='#define-armor'>Armor Score</a>; &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Improved Small Dagger", tier: 2, pages: ["CRB 124"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+2", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Paired:</em></strong> +3 to <a href='#define-weapon'>primary weapon</a> damage to targets within <a href='#define-range'>Melee</a> range" },
{ label: "Improved Whip", tier: 2, pages: ["CRB 124"], errata: false, trait: "Presence", range: "Very Close", damage: "d6+2", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Startling:</em></strong> <strong><a href='#define-stress'>Mark a Stress</a></strong> to crack the whip and force all <a href='#define-adversary'>adversaries</a> within <a href='#define-range'>Melee</a> range back to <a href='#define-range'>Close</a> range." },
{ label: "Improved Grappler", tier: 2, pages: ["CRB 124"], errata: false, trait: "Finesse", range: "Close", damage: "d6+2", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Hooked:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, you can pull the target into <a href='#define-range'>Melee</a> range." },
{ label: "Improved Hand Crossbow", tier: 2, pages: ["CRB 124"], errata: false, trait: "Finesse", range: "Far", damage: "d6+3", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Spiked Shield", tier: 2, pages: ["CRB 124"], errata: false, trait: "Strength", range: "Melee", damage: "d6+2", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Double Duty:</em></strong> +1 to <a href='#define-armor'>Armor Score</a>; +1 to <a href='#define-weapon'>primary weapon</a> damage within <a href='#define-range'>Melee</a> range" },
{ label: "Parrying Dagger", tier: 2, pages: ["CRB 124"], errata: false, trait: "Finesse", range: "Melee", damage: "d6+2", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Parry:</em></strong> When you are attacked, roll this weapon's <a href='#define-damage-roll'>damage dice</a>. If any of the attacker's damage dice rolled the same value as your dice, the matching results are discarded from the attacker's damage dice before the damage you take is totaled." },
{ label: "Returning Axe", tier: 2, pages: ["CRB 124"], errata: false, trait: "Agility", range: "Close", damage: "d6+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Returning:</em></strong> When this <a href='#define-weapon'>weapon</a> is <a href='#define-weapon'>thrown</a> within its <a href='#define-range'>range</a>, it appears in your hand immediately after the attack." },
{ label: "Advanced Shortsword", tier: 3, pages: ["CRB 125"], errata: false, trait: "Agility", range: "Melee", damage: "d8+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Paired:</em></strong> +4 to <a href='#define-weapon'>primary weapon</a> damage to targets within <a href='#define-range'>Melee</a> range" },
{ label: "Advanced Round Shield", tier: 3, pages: ["CRB 125"], errata: false, trait: "Strength", range: "Melee", damage: "d4+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Protective:</em></strong> +3 to <a href='#define-armor'>Armor Score</a>" },
{ label: "Advanced Tower Shield", tier: 3, pages: ["CRB 125"], errata: false, trait: "Strength", range: "Melee", damage: "d6+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Barrier:</em></strong> +4 to <a href='#define-armor'>Armor Score</a>; &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Advanced Small Dagger", tier: 3, pages: ["CRB 125"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Paired:</em></strong> +4 to <a href='#define-weapon'>primary weapon</a> damage to targets within <a href='#define-range'>Melee</a> range" },
{ label: "Advanced Whip", tier: 3, pages: ["CRB 125"], errata: false, trait: "Presence", range: "Very Close", damage: "d6+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Startling:</em></strong> <strong><a href='#define-stress'>Mark a Stress</a></strong> to crack the whip and force all <a href='#define-adversary'>adversaries</a> within <a href='#define-range'>Melee</a> range back to <a href='#define-range'>Close</a> range." },
{ label: "Advanced Grappler", tier: 3, pages: ["CRB 125"], errata: false, trait: "Finesse", range: "Close", damage: "d6+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Hooked:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, you can pull the target into <a href='#define-range'>Melee</a> range." },
{ label: "Advanced Hand Crossbow", tier: 3, pages: ["CRB 125"], errata: false, trait: "Finesse", range: "Far", damage: "d6+5", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Buckler", tier: 3, pages: ["CRB 125"], errata: true, trait: "Agility", range: "Melee", damage: "d4+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Deflecting:</em></strong> When you are attacked, you can <strong><a href='#define-armor'>mark an Armor Slot</a></strong> to gain a bonus to your <a href='#define-evasion'>Evasion</a> equal to your available <a href='#define-armor'>Armor Slots</a> against the attack." },
{ label: "Powered Gauntlet", tier: 3, pages: ["CRB 125"], errata: false, trait: "Knowledge", range: "Close", damage: "d6+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Charged:</em></strong> <strong><a href='#define-stress'>Mark a Stress</a></strong> to gain a +1 bonus to your <a href='#define-damage-roll'>Proficiency</a> on a <a href='#define-weapon'>primary weapon</a> attack." },
{ label: "Hand Sling", tier: 3, pages: ["CRB 125"], errata: false, trait: "Finesse", range: "Very Close", damage: "d6+4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Versatile:</em></strong> This <a href='#define-weapon'>weapon</a> can also be used with these statistics&mdash;Finesse, Close, d8+4." },
{ label: "Legendary Shortsword", tier: 4, pages: ["CRB 125"], errata: false, trait: "Agility", range: "Melee", damage: "d8+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Paired:</em></strong> +5 to <a href='#define-weapon'>primary weapon</a> damage to targets within <a href='#define-range'>Melee</a> range" },
{ label: "Legendary Round Shield", tier: 4, pages: ["CRB 125"], errata: false, trait: "Strength", range: "Melee", damage: "d4+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Protective:</em></strong> +4 to <a href='#define-armor'>Armor Score</a>" },
{ label: "Legendary Tower Shield", tier: 4, pages: ["CRB 125"], errata: false, trait: "Strength", range: "Melee", damage: "d6+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Barrier:</em></strong> +5 to <a href='#define-armor'>Armor Score</a>; &minus;1 to Evasion." },
{ label: "Legendary Small Dagger", tier: 4, pages: ["CRB 125"], errata: false, trait: "Finesse", range: "Melee", damage: "d8+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Paired:</em></strong> +5 to <a href='#define-weapon'>primary weapon</a> damage to targets within <a href='#define-range'>Melee</a> range" },
{ label: "Legendary Whip", tier: 4, pages: ["CRB 125"], errata: false, trait: "Presence", range: "Very Close", damage: "d6+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Startling:</em></strong> <strong><a href='#define-stress'>Mark a Stress</a></strong> to crack the whip and force all <a href='#define-adversary'>adversaries</a> within <a href='#define-range'>Melee</a> range back to <a href='#define-range'>Close</a> range." },
{ label: "Legendary Grappler", tier: 4, pages: ["CRB 125"], errata: false, trait: "Finesse", range: "Close", damage: "d6+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Hooked:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, you can pull the target into <a href='#define-range'>Melee</a> range." },
{ label: "Legendary Hand Crossbow", tier: 4, pages: ["CRB 125"], errata: false, trait: "Finesse", range: "Far", damage: "d6+7", damagetype: "phy", burden: "One-Handed", feature: "" },
{ label: "Braveshield", tier: 4, pages: ["CRB 125"], errata: false, trait: "Agility", range: "Melee", damage: "d4+6", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Sheltering:</em></strong> When you mark an <a href='#define-armor'>Armor Slot</a>, it reduces damage for you and all allies within <a href='#define-range'>Melee</a> range of you who took the same damage." },
{ label: "Knuckle Claws", tier: 4, pages: ["CRB 125"], errata: false, trait: "Strength", range: "Melee", damage: "d6+8", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Doubled Up:</em></strong> When you make an attack with your <a href='#define-weapon'>primary weapon</a>, you can deal damage to another target within <a href='#define-range'>Melee</a> range." },
{ label: "Primer Shard", tier: 4, pages: ["CRB 125"], errata: false, trait: "Instinct", range: "Very Close", damage: "d4", damagetype: "phy", burden: "One-Handed", feature: "<strong><em>Locked On:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, your next attack against the same target with your <a href='#define-weapon'>primary weapon</a> automatically succeeds." },
];
// armor
const armorList = [
{ label: "Gambeson Armor", tier: 1, pages: ["CRB 126"], errata: false, thresholdmajor: 5, thresholdsevere: 11, score: 3, feature: "<strong><em>Flexible:</em></strong> +1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Leather Armor", tier: 1, pages: ["CRB 126"], errata: false, thresholdmajor: 6, thresholdsevere: 13, score: 3, feature: "" },
{ label: "Chainmail Armor", tier: 1, pages: ["CRB 126"], errata: false, thresholdmajor: 7, thresholdsevere: 15, score: 4, feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Full Plate Armor", tier: 1, pages: ["CRB 126"], errata: false, thresholdmajor: 8, thresholdsevere: 17, score: 4, feature: "<strong><em>Very Heavy:</em></strong> &minus;2 to <a href='#define-evasion'>Evasion</a>; &minus;1 to <a href='#define-agility'>Agility</a>" },
{ label: "Improved Gambeson Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 7, thresholdsevere: 16, score: 4, feature: "<strong><em>Flexible:</em></strong> +1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Improved Leather Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 9, thresholdsevere: 20, score: 4, feature: "" },
{ label: "Improved Chainmail Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 11, thresholdsevere: 24, score: 5, feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Improved Full Plate Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 13, thresholdsevere: 28, score: 5, feature: "<strong><em>Very Heavy:</em></strong> &minus;2 to <a href='#define-evasion'>Evasion</a>; &minus;1 to <a href='#define-agility'>Agility</a>" },
{ label: "Elundrian Chain Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 9, thresholdsevere: 21, score: 4, feature: "<strong><em>Warded:</em></strong> You reduce incoming <a href='#define-damage-type'>magic damage</a> by your <a href='#define-armor'>Armor Score</a> before applying it to your <a href='#define-hit-point'>damage thresholds</a>." },
{ label: "Harrowbone Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 9, thresholdsevere: 21, score: 4, feature: "<strong><em>Resilient:</em></strong> Before you mark your last <a href='#define-armor'>Armor Slot</a>, roll a <strong>d6</strong>. On a result of 6, reduce the severity by one <a href='#define-hit-point'>threshold</a> without marking an Armor Slot." },
{ label: "Irontree Breastplate Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 9, thresholdsevere: 20, score: 4, feature: "<strong><em>Reinforced:</em></strong> When you mark your last <a href='#define-armor'>Armor Slot</a>, increase your <a href='#define-hit-point'>damage thresholds</a> by +2 until you clear at least 1 Armor Slot." },
{ label: "Runetan Floating Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 9, thresholdsevere: 20, score: 4, feature: "<strong><em>Shifting:</em></strong> When you are targeted for an attack, you can <strong><a href='#define-armor'>mark an Armor Slot</a></strong> to give the attack roll against you <a href='#define-advantage'>disadvantage</a>." },
{ label: "Tyris Soft Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 8, thresholdsevere: 18, score: 5, feature: "<strong><em>Quiet:</em></strong> You gain a +2 bonus to rolls you make to move silently." },
{ label: "Rosewild Armor", tier: 2, pages: ["CRB 126"], errata: false, thresholdmajor: 11, thresholdsevere: 23, score: 5, feature: "<strong><em>Hopeful:</em></strong> When you would spend a <a href='#define-hope'>Hope</a>, you can <strong><a href='#define-armor'>mark an Armor Slot</a></strong> instead." },
{ label: "Advanced Gambeson Armor", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 9, thresholdsevere: 23, score: 5, feature: "<strong><em>Flexible:</em></strong> +1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Advanced Leather Armor", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 11, thresholdsevere: 27, score: 5, feature: "" },
{ label: "Advanced Chainmail Armor", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 13, thresholdsevere: 31, score: 6, feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Advanced Full Plate Armor", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 15, thresholdsevere: 35, score: 6, feature: "<strong><em>Very Heavy:</em></strong> &minus;2 to <a href='#define-evasion'>Evasion</a>; &minus;1 to <a href='#define-agility'>Agility</a>" },
{ label: "Bellamoi Fine Armor", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 11, thresholdsevere: 27, score: 5, feature: "<strong><em>Gilded:</em></strong> +1 to <a href='#define-presence'>Presence</a>" },
{ label: "Dragonscale Armor", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 11, thresholdsevere: 27, score: 5, feature: "<strong><em>Impenetrable:</em></strong> Once per <a href='#define-downtime'>short rest</a>, when you would mark your last <a href='#define-hit-point'>Hit Point</a>, you can instead mark a <a href='#define-stress'>Stress</a>." },
{ label: "Spiked Plate Armor", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 10, thresholdsevere: 25, score: 5, feature: "<strong><em>Sharp:</em></strong> On a successful attack against a target within <a href='#define-range'>Melee</a> range, add a <strong>d4</strong> to the damage roll." },
{ label: "Bladefare Armor", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 16, thresholdsevere: 39, score: 6, feature: "<strong><em>Physical:</em></strong> You can't mark an <a href='#define-armor'>Armor Slot</a> to reduce <a href='#define-damage-type'>magic damage</a>." },
{ label: "Monett's Cloak", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 16, thresholdsevere: 39, score: 6, feature: "<strong><em>Magic:</em></strong> You can't mark an <a href='#define-armor'>Armor Slot</a> to reduce <a href='#define-damage-type'>physical damage</a>." },
{ label: "Runes of Fortification", tier: 3, pages: ["CRB 127"], errata: false, thresholdmajor: 17, thresholdsevere: 43, score: 6, feature: "<strong><em>Painful:</em></strong> Each time you mark an <a href='#define-armor'>Armor Slot</a>, you must mark a <a href='#define-stress'>Stress</a>." },
{ label: "Legendary Gambeson Armor", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 11, thresholdsevere: 32, score: 6, feature: "<strong><em>Flexible:</em></strong> +1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Legendary Leather Armor", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 13, thresholdsevere: 36, score: 6, feature: "" },
{ label: "Legendary Chainmail Armor", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 15, thresholdsevere: 40, score: 7, feature: "<strong><em>Heavy:</em></strong> &minus;1 to <a href='#define-evasion'>Evasion</a>" },
{ label: "Legendary Full Plate Armor", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 17, thresholdsevere: 44, score: 7, feature: "<strong><em>Very Heavy:</em></strong> &minus;2 to <a href='#define-evasion'>Evasion</a>; &minus;1 to <a href='#define-agility'>Agility</a>" },
{ label: "Dunamis Silkchain", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 13, thresholdsevere: 36, score: 7, feature: "<strong><em>Timeslowing:</em></strong> <strong><a href='#define-armor'>Mark an Armor Slot</a></strong> to roll a <strong>d4</strong> and add its result as a bonus to your <a href='#define-evasion'>Evasion</a> against an incoming attack." },
{ label: "Channeling Armor", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 13, thresholdsevere: 36, score: 5, feature: "<strong><em>Channeling:</em></strong> +1 to <a href='#define-spellcast-roll'>Spellcast Rolls</a>" },
{ label: "Emberwoven Armor", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 13, thresholdsevere: 36, score: 6, feature: "<strong><em>Burning:</em></strong> When an <a href='#define-adversary'>adversary</a> attacks you within <a href='#define-range'>Melee</a> range, they mark a <a href='#define-stress'>Stress</a>." },
{ label: "Full Fortified Armor", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 15, thresholdsevere: 40, score: 4, feature: "<strong><em>Fortified:</em></strong> When you mark an <a href='#define-armor'>Armor Slot</a>, you reduce the severity of an attack by two <a href='#define-hit-point'>thresholds</a> instead of one." },
{ label: "Veritas Opal Armor", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 13, thresholdsevere: 36, score: 6, feature: "<strong><em>Truthseeking:</em></strong> This <a href='#define-armor'>armor</a> glows when another creature within <a href='#define-range'>Close</a> range tells a lie." },
{ label: "Savior Chainmail", tier: 4, pages: ["CRB 127"], errata: false, thresholdmajor: 18, thresholdsevere: 48, score: 8, feature: "<strong><em>Difficult:</em></strong> &minus;1 to all character <a href='#define-trait'>traits</a> and <a href='#define-evasion'>Evasion</a>" }
];
// loot
const lootList = [
{ label: "Premium Bedroll", name: "premium-bedroll", pages: ["CRB 129"], errata: false, feature: "During <a href='#define-downtime'>downtime</a>, you automatically clear a <a href='#define-stress'>Stress</a>." },
{ label: "Piper Whistle", name: "piper-whistle", pages: ["CRB 129"], errata: false, feature: "This handcrafted whistle has a distinctive sound. When you blow this whistle, its piercing tone can be heard within a 1-mile (1.6 km) radius." },
{ label: "Charging Quiver", name: "charging-quiver", pages: ["CRB 129"], errata: false, feature: "When you succeed on an attack with an arrow stored in this quiver, gain a bonus to the <a href='#define-damage-roll'>damage roll</a> equal to your current <a href='#define-tier'>tier</a>." },
{ label: "Alistair's Torch", name: "alistairs-torch", pages: ["CRB 129"], errata: false, feature: "You can light this magic torch at will. The flame's light fills a much larger space than it should, enough to illuminate a cave bright as day." },
{ label: "Speaking Orbs", name: "speaking-orbs", pages: ["CRB 129"], errata: false, feature: "This pair of orbs allows any creatures holding them to communicate with each other across any distance." },
{ label: "Manacles", name: "manacles", pages: ["CRB 129"], errata: false, feature: "This pair of locking cuffs comes with a key." },
{ label: "Arcane Cloak", name: "arcane-cloak", pages: ["CRB 129"], errata: false, feature: "A creature with a <a href='#define-subclass'>Spellcast trait</a> wearing this cloak can adjust its color, texture, and size at will." },
{ label: "Woven Net", name: "woven-net", pages: ["CRB 129"], errata: false, feature: "You can make a <a href='#define-trait-roll'>Finesse Roll</a> using this net to trap a small creature. A trapped target can break free with a successful <a href='#define-attack-roll'>Attack Roll</a> <strong>(16)</strong>." },
{ label: "Fire Jar", name: "fire-jar", pages: ["CRB 129"], errata: false, feature: "You can pour out the strange liquid contents of this jar to instantly produce fire. The contents regenerate when you take a <a href='#define-downtime'>long rest</a>." },
{ label: "Suspended Rod", name: "suspended-rod", pages: ["CRB 129"], errata: false, feature: "This flat rod is inscribed with runes. When you activate the rod, it is immediately suspended in place. Until the rod is deactivated, it can't move, doesn't abide by the rules of gravity, and remains in place." },
{ label: "Glamour Stone", name: "glamour-stone", pages: ["CRB 129"], errata: false, feature: "Activate this pebble-sized stone to memorize the appearance of someone you can see. <strong><a href='#define-hope'>Spend a Hope</a></strong> to magically recreate this guise on yourself as an illusion." },
{ label: "Empty Chest", name: "empty-chest", pages: ["CRB 129"], errata: false, feature: "This magical chest appears empty. When you speak a specific trigger word or action and open the chest, you can see the items stored within it." },
{ label: "Companion Case", name: "companion-case", pages: ["CRB 129"], errata: false, feature: "This case can fit a small animal companion. While the companion is inside, the animal and case are <a href='#define-damage-type'>immune</a> to all damage and harmful effects." },
{ label: "Piercing Arrows", name: "piercing-arrows", pages: ["CRB 129"], errata: false, feature: "Three times per <a href='#define-downtime'>rest</a> when you succeed on an attack with one of these arrows, you can add your <a href='#define-damage-roll'>Proficiency</a> to the <a href='#define-damage-roll'>damage roll</a>." },
{ label: "Valorstone", name: "valorstone", pages: ["CRB 129"], errata: false, feature: "You can attach this stone to <a href='#define-armor'>armor</a> that doesn't already have a feature. The armor gains the following feature.<br><strong><em>Resilient:</em></strong> Before you mark your last <a href='#define-armor'>Armor Slot</a>, roll a <strong>d6</strong>. On a result of 6,reduce the severity by one threshold without marking an Armor Slot." },
{ label: "Skeleton Key", name: "skeleton-key", pages: ["CRB 129"], errata: false, feature: "When you use this key to open a locked door, you gain advantage on the <a href='#define-trait-roll'>Finesse Roll</a>." },
{ label: "Arcane Prism", name: "arcane-prism", pages: ["CRB 129"], errata: false, feature: "Position this prism in a location of your choosing and activate it. All allies within <a href='#define-range'>Close</a> range of it gain a +1 bonus to their <a href='#define-spellcast-roll'>Spellcast Rolls</a>. While activated, the prism can't be moved. Once the prism is deactivated, it can't be activated again until your next <a href='#define-downtime'>long rest</a>." },
{ label: "Minor Stamina Potion Recipe", name: "minor-stamina-potion-recipe", pages: ["CRB 129"], errata: false, feature: "As a <a href='#define-downtime-move'>downtime move</a>, you can use the bone of a creature to craft a <a href='#define-consumable-minor-stamina-potion'>Minor Stamina Potion</a>." },
{ label: "Minor Health Potion Recipe", name: "minor-heath-potion-recipe", pages: ["CRB 129"], errata: false, feature: "As a <a href='#define-downtime-move'>downtime move</a>, you can use a vial of blood to craft a <a href='#define-consumable-minor-health-potion'>Minor Health Potion</a>." },
{ label: "Homing Compasses", name: "homing-compasses", pages: ["CRB 130"], errata: false, feature: "These two compasses point toward each other no matter how far apart they are." },
{ label: "Corrector Sprite", name: "corrector-sprite", pages: ["CRB 130"], errata: false, feature: "This tiny sprite sits in the curve of your ear canal and whispers helpful advice during combat. Once per <a href='#define-downtime'>short rest</a>, you can gain <a href='#define-advantage'>advantage</a> on an <a href='#define-attack-roll'>attack roll</a>." },
{ label: "Gecko Gloves", name: "gecko-gloves", pages: ["CRB 130"], errata: false, feature: "You can climb up vertical surfaces and across ceilings." },
{ label: "Lorekeeper", name: "lorekeeper", pages: ["CRB 130"], errata: false, feature: "You can store the name and details of up to three hostile creatures inside this book. You gain a +1 bonus to <a href='#define-action-roll'>action rolls</a> against those creatures." },
{ label: "Vial of Darksmoke Recipe", name: "vial-of-darksmoke-recipe", pages: ["CRB 130"], errata: false, feature: "As a <a href='#define-downtime-move'>downtime move</a>, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to craft a <a href='#define-consumable-vial-of-darksmoke'>Vial of Darksmoke</a>." },
{ label: "Bloodstone", name: "bloodstone", pages: ["CRB 130"], errata: false, feature: "You can attach this stone to a <a href='#define-weapon'>weapon</a> that doesn't already have a feature. The weapon gains the following feature.<br><strong><em>Brutal:</em><strong> When you roll the maximum value on a <a href='#define-damage-roll'>damage die</a>, roll an additional <a href='#define-damage-roll'>damage die</a>." },
{ label: "Greatstone", name: "greatstone", pages: ["CRB 130"], errata: false, feature: "You can attach this stone to a <a href='#define-weapon'>weapon</a> that doesn't already have a feature. The weapon gains the following feature.<br><strong><em>Powerful:</em></strong> On a successful <a href='#define-attack-roll'>attack</a>, roll an additional <a href='#define-damage-roll'>damage die</a> and discard the lowest result." },
{ label: "Glider", name: "glider", pages: ["CRB 130"], errata: false, feature: "While falling, you can <strong><a href='#define-stress'>mark a Stress</a></strong> to deploy this small parachute and glide safely to the ground." },
{ label: "Ring of Silence", name: "ring-of-silence", pages: ["CRB 130"], errata: false, feature: "<strong><a href='#define-hope'>Spend a Hope</a></strong> to activate this ring. Your footsteps are silent until your next <a href='#define-downtime'>rest</a>." },
{ label: "Calming Pendant", name: "calming-pendant", pages: ["CRB 130"], errata: false, feature: "When you would mark your last <a href='#define-stress'>Stress</a>, roll a <strong>d6</strong>. On a result of 5 or higher, don't mark it." },
{ label: "Dual Flask", name: "dual-flask", pages: ["CRB 130"], errata: false, feature: "This flask can hold two different liquids. You can swap between them by flipping a small switch on the flask's side." },
{ label: "Bag of Ficklesand", name: "bag-of-ficklesand", pages: ["CRB 130"], errata: false, feature: "You can convince this small bag of sand to be much heavier or lighter with a successful <strong><a href='#define-trait-roll'>Presence Roll (10)</a></strong>. Additionally, on a successful <strong><a href='#define-trait-roll'>Finesse Roll (10)</a></strong>, you can blow a bit of sand into a target's face to make them <a href='#define-temporary'>temporarily</a> <a href='#define-condition'><em>Vulnerable</em></a>." },
{ label: "Ring of Resistance", name: "ring-of-resistance", pages: ["CRB 130"], errata: false, feature: "Once per <a href='#define-downtime'>long rest</a>, you can activate this ring after a successful attack against you to halve the damage." },
{ label: "Phoenix Feather", name: "phoenix-feather", pages: ["CRB 130"], errata: false, feature: "If you have at least one Phoenix Feather on you when you fall unconscious, you gain a +1 bonus to the roll you make to determine whether you gain a <a href='#define-death'>scar</a>." },
{ label: "Box of Many Goods", name: "box-of-many-goods", pages: ["CRB 130"], errata: false, feature: "Once per <a href='#define-downtime'>long rest</a>, you can open this small box and roll a d12. On a result of 1&ndash;6, it's empty. On a result of 7&ndash;10, it contains one random common consumable. On a result of 11&ndash;12, it contains two random common <a href='#define-consumable'>consumables</a>." },
{ label: "Airblade Charm", name: "airblade-charm", pages: ["CRB 130"], errata: false, feature: "You can attach this charm to a <a href='#define-weapon'>weapon</a> with a <a href='#define-range'>Melee</a> range. Three times per <a href='#define-downtime'>rest</a>, you can activate the charm and attack a target within <a href='#define-range'>Close</a> range." },
{ label: "Portal Seed", name: "portal-seed", pages: ["CRB 130"], errata: false, feature: "You can plant this seed in the ground to grow a portal in that spot. The portal is ready to use in 24 hours. You can use this portal to travel to any other location where you planted a portal seed. A portal can be destroyed by dealing any amount of <a href='#define-damage-type'>magic damage</a> to it." },
{ label: "Paragon's Chain", name: "paragons-chain", pages: ["CRB 130"], errata: false, feature: "As a <a href='#define-downtime-move'>downtime move</a>, you can meditate on an ideal or principle you hold dear and focus your will into this chain. Once per <a href='#define-downtime'>long rest</a>, you can <strong><a href='#define-hope'>spend a Hope</a></strong> to roll a <strong>d20</strong> as your <a href='#define-action-roll'>Hope Die</a> for rolls that directly align with that principle." },
{ label: "Elusive Amulet", name: "elusive-amulet", pages: ["CRB 130"], errata: false, feature: "Once per <a href='#define-downtime'>long rest</a>, you can activate this amulet to become <a href='#define-condition'><em>Hidden</em></a> until you move. While <em>Hidden</em> in this way, you remain unseen even if an <a href='#define-adversary'>adversary</a> moves to where they would normally see you." },
{ label: "Hopekeeper Locket", name: "hopekeeper-locket", pages: ["CRB 130"], errata: false, feature: "During a <a href='#define-downtime'>long rest</a>, if you have 6 <a href='#define-hope'>Hope</a>, you can <strong><a href='#define-hope'>spend a Hope</a></strong> to imbue this locket with your bountiful resolve. When you have 0 <a href='#define-hope'>Hope</a>, you can use the locket to immediately gain a <a href='#define-hope'>Hope</a>. The locket must be re-imbued before it can be used this way again." },
{ label: "Infinite Bag", name: "infinite-bag", pages: ["CRB 130"], errata: false, feature: "When you store items in this bag, they are kept in a pocket dimension that never runs out of space. You can retrieve an item at any time." },
{ label: "Stride Relic", name: "stride-relic", pages: ["CRB 130"], errata: false, feature: "You gain a +1 bonus to your <a href='#define-agility'>Agility</a>. You can only carry one relic." },
{ label: "Bolster Relic", name: "bolster-relic", pages: ["CRB 130"], errata: false, feature: "You gain a +1 bonus to your <a href='#define-strength'>Strength</a>. You can only carry one relic." },
{ label: "Control Relic", name: "control-relic", pages: ["CRB 130"], errata: false, feature: "You gain a +1 bonus to your  <a href='#define-finesse'>Finesse</a>. You can only carry one relic." },
{ label: "Attune Relic", name: "attune-relic", pages: ["CRB 130"], errata: false, feature: "You gain a +1 bonus to your  <a href='#define-instinct'>Instinct</a>. You can only carry one relic." },
{ label: "Charm Relic", name: "charm-relic", pages: ["CRB 130"], errata: false, feature: "You gain a +1 bonus to your  <a href='#define-presence'>Presence</a>. You can only carry one relic." },
{ label: "Enlighten Relic", name: "enlighten-relic", pages: ["CRB 130"], errata: false, feature: "You gain a +1 bonus to your  <a href='#define-knowledge'>Knowledge</a>. You can only carry one relic." },
{ label: "Honing Relic", name: "honing-relic", pages: ["CRB 130"], errata: false, feature: "You gain a +1 bonus to an <a href='#define-experience'>Experience</a> of your choice. You can only carry one relic." },
{ label: "Flickerfly Pendant", name: "flickerfly-pendant", pages: ["CRB 130"], errata: false, feature: "While you carry this pendant, your <a href='#define-weapon'>weapons</a> with a <a href='#define-range'>Melee</a> range that deal <a href='#define-damage-type'>physical damage</a> have a gossamer sheen and can attack targets within <a href='#define-range'>Very Close</a> range." },
{ label: "Lakestrider Boots", name: "laskestrider-boots", pages: ["CRB 130"], errata: false, feature: "You can walk on the surface of water as if it were soft ground.</span></td>" },
{ label: "Clay Companion", name: "clay-companion", pages: ["CRB 131"], errata: false, feature: "When you sculpt this ball of clay into a clay animal companion, it behaves as that animal. For example, a clay spider can spin clay webs, while a clay bird can fly. The clay companion retains memory and identity across different shapes, but they can adopt new mannerisms with each form." },
{ label: "Mythic Dust Recipe", name: "mythic-dust-recipe", pages: ["CRB 131"], errata: false, feature: "As a <a href='#define-downtime-move'>downtime move</a>, you can use a handful of fine gold dust to craft <a href='#define-consumable-mythic-dust'>Mythic Dust</a>." },
{ label: "Shard of Memory", name: "shard-of-memory", pages: ["CRB 131"], errata: false, feature: "Once per <a href='#define-downtime'>long rest</a>, you can <strong><a href='#define-hope'>spend 2 Hope</a></strong> to recall a <a href='#define-domain-card'>domain card</a> from your <a href='#define-loadout'>vault</a> instead of paying its <a href='#define-domain-card'>Recall Cost</a>." },
{ label: "Gem of Alacrity", name: "gem-of-alacrity", pages: ["CRB 131"], errata: false, feature: "You can attach this gem to a <a href='#define-weapon'>weapon</a>, allowing you to use your <a href='#define-agility'>Agility</a> when making an <a href='#define-attack-roll'>attack</a> with that weapon." },
{ label: "Gem of Might", name: "gem-of-might", pages: ["CRB 131"], errata: false, feature: "You can attach this gem to a <a href='#define-weapon'>weapon</a>, allowing you to use your <a href='#define-strength'>Strength</a> when making an <a href='#define-attack-roll'>attack</a> with that weapon." },
{ label: "Gem of Precision", name: "gem-of-precision", pages: ["CRB 131"], errata: false, feature: "You can attach this gem to a <a href='#define-weapon'>weapon</a>, allowing you to use your <a href='#define-finesse'>Finesse</a> when making an <a href='#define-attack-roll'>attack</a> with that weapon." },
{ label: "Gem of Insight", name: "gem-of-insight", pages: ["CRB 131"], errata: false, feature: "You can attach this gem to a <a href='#define-weapon'>weapon</a>, allowing you to use your <a href='#define-instinct'>Instinct</a> when making an <a href='#define-attack-roll'>attack</a> with that weapon." },
{ label: "Gem of Audacity", name: "gem-of-audacity", pages: ["CRB 131"], errata: false, feature: "You can attach this gem to a <a href='#define-weapon'>weapon</a>, allowing you to use your <a href='#define-presence'>Presence</a> when making an <a href='#define-attack-roll'>attack</a> with that weapon." },
{ label: "Gem of Sagacity", name: "gem-of-sagacity", pages: ["CRB 131"], errata: false, feature: "You can attach this gem to a <a href='#define-weapon'>weapon</a>, allowing you to use your <a href='#define-knowledge'>Knowledge</a> when making an <a href='#define-attack-roll'>attack</a> with that weapon." },
{ label: "Ring of Unbreakable Resolve", name: "ring-of-unbreakable-resolve", pages: ["CRB 131"], errata: false, feature: "Once per session, when the GM spends a <a href='#define-fear'>Fear</a>, you can spend 4 <a href='#define-hope'>Hope</a> to cancel the effects of that spent <a href='#define-fear'>Fear</a>." },
{ label: "Belt of Unity", name: "belt-of-unity", pages: ["CRB 131"], errata: false, feature: "Once per session, you can <strong><a href='#define-hope'>spend 5 Hope</a></strong> to lead a <a href='#define-tag-team-roll'>Tag Team Roll</a> with three PCs instead of two." }
];
// consumables
const consumableList = [
{ label: "Stride Potion", name: "stride-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your next <a href='#define-trait-roll'>Agility Roll</a>." },
{ label: "Bolster Potion", name: "bolster-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your next <a href='#define-trait-roll'>Strength Roll</a>." },
{ label: "Control Potion", name: "control-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your next <a href='#define-trait-roll'>Finesse Roll</a>." },
{ label: "Attune Potion", name: "attune-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your next <a href='#define-trait-roll'>Instinct Roll</a>." },
{ label: "Charm Potion", name: "charm-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your next <a href='#define-trait-roll'>Presence Roll</a>." },
{ label: "Enlighten Potion", name: "enlighten-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your next <a href='#define-trait-roll'>Knowledge Roll</a>." },
{ label: "Minor Health Potion", name: "minor-health-potion", pages: ["CRB 132"], errata: false, feature: "Clear <strong>1d4</strong> <a href='#define-hit-point'>Hit Points</a>." },
{ label: "Minor Stamina Potion", name: "minor-stamina-potion", pages: ["CRB 132"], errata: false, feature: "Clear <strong>1d4</strong> <a href='#define-stress'>Stress</a>." },
{ label: "Grindletooth Venom", name: "grindletooth-venom", pages: ["CRB 132"], errata: false, feature: "You can apply this venom to a <a href='#define-weapon'>weapon</a> that deals <a href='#define-damage-type'>physical damage</a> to add a <strong>d6</strong> to your next <a href='#define-damage-roll'>damage roll</a> with that weapon." },
{ label: "Varik Leaves", name: "varik-leaves", pages: ["CRB 132"], errata: false, feature: "You can eat these paired leaves to immediately gain 2 <a href='#define-hope'>Hope</a>." },
{ label: "Vial of Moondrip", name: "vial-of-moondrop", pages: ["CRB 132"], errata: false, feature: "When you drink the contents of this vial, you can see in total darkness until your next <a href='#define-downtime'>rest</a>." },
{ label: "Unstable Arcane Shard", name: "unstable-arcane-shard", pages: ["CRB 132"], errata: false, feature: "You can make a <a href='#define-trait-roll'>Finesse Roll</a> to throw this shard at a group of adversaries within <a href='#define-range'>Far</a> range. Targets you succeed against take <strong>1d20</strong> <a href='#define-damage-type'>magic damage</a>." },
{ label: "Potion of Stability", name: "potion-of-stability", pages: ["CRB 132"], errata: false, feature: "You can drink this potion to choose one additional <a href='#define-downtime-move'>downtime move</a>." },
{ label: "Improved Grindletooth Venom", name: "improved-grindletooth-venom", pages: ["CRB 132"], errata: false, feature: "You can apply this venom to a <a href='#define-weapon'>weapon</a> that deals <a href='#define-damage-type'>physical damage</a> to add a <strong>d8</strong> to your next <a href='#define-damage-roll'>damage roll</a> with that weapon." },
{ label: "Morphing Clay", name: "morphing-clay", pages: ["CRB 132"], errata: false, feature: "You can spend 4 <a href='#define-hope'>Hope</a> to use this clay, altering your face enough to make you unrecognizable until your next <a href='#define-downtime'>rest</a>." },
{ label: "Vial of Darksmoke", name: "vial-of-darksmoke", pages: ["CRB 132"], errata: false, feature: "When an <a href='#define-adversary'>adversary</a> attacks you, use this vial and roll a number of <strong>d6</strong> equal to your <a href='#define-agility'>Agility</a>. Add the highest result to your <a href='#define-evasion'>Evasion</a> against the attack." },
{ label: "Jumping Root", name: "jumping-root", pages: ["CRB 132"], errata: false, feature: "Eat this root to leap up to <a href='#define-range'>Far</a> range once without needing to roll." },
{ label: "Snap Powder", name: "snap-powder", pages: ["CRB 132"], errata: false, feature: "<strong><a href='#define-stress'>Mark a Stress</a></strong> and clear a <a href='#define-hit-point'>Hit Point</a>." },
{ label: "Health Potion", name: "health-potion", pages: ["CRB 132"], errata: false, feature: "Clear <strong>1d4+1</strong> <a href='#define-hit-point'>Hit Points</a>." },
{ label: "Stamina Potion", name: "stamina-potion", pages: ["CRB 132"], errata: false, feature: "Clear <strong>1d4+1</strong> <a href='#define-stress'>Stress</a>." },
{ label: "Armor Stitcher", name: "armor-stitcher", pages: ["CRB 132"], errata: false, feature: "You can use this stitcher to spend any number of Hope and clear that many <a href='#define-armor'>Armor Slots</a>." },
{ label: "Gill Salve", name: "gill-salve", pages: ["CRB 132"], errata: false, feature: "You can apply this salve to your neck to breathe underwater for a number of minutes equal to your <a href='#define-level'>level" },
{ label: "Replication Parchment", name: "replication-parchment", pages: ["CRB 132"], errata: false, feature: "By touching this piece of parchment to another, you can perfectly copy the second parchment's contents. Once used, this parchment becomes mundane paper." },
{ label: "Improved Arcane Shard", name: "improved-arcane-shard", pages: ["CRB 132"], errata: false, feature: "You can make a <a href='#define-trait-roll'>Finesse Roll</a> to throw this shard at a group of adversaries within <a href='#define-range'>Far</a> range. Targets you succeed against take <strong>2d20</strong> <a href='#define-damage-type'>magic damage</a>." },
{ label: "Major Stride Potion", name: "major-stride-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your <a href='#define-agility'>Agility</a> until your next <a href='#define-downtime'>rest</a>." },
{ label: "Major Bolster Potion", name: "major-bolster-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your <a href='#define-strength'>Strength</a> until your next <a href='#define-downtime'>rest</a>." },
{ label: "Major Control Potion", name: "major-control-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your <a href='#define-finesse'>Finesse</a> until your next <a href='#define-downtime'>rest</a>." },
{ label: "Major Attune Potion", name: "major-attune-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your <a href='#define-instinct'>Instinct</a> until your next <a href='#define-downtime'>rest</a>." },
{ label: "Major Charm Potion", name: "major-charm-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your <a href='#define-presence'>Presence</a> until your next <a href='#define-downtime'>rest</a>." },
{ label: "Major Enlighten Potion", name: "major-enlighten-potion", pages: ["CRB 132"], errata: false, feature: "You gain a +1 bonus to your <a href='#define-knowledge'>Knowledge</a> until your next <a href='#define-downtime'>rest</a>." },
{ label: "Blood of the Yorgi", name: "blood-of-the-yorgi", pages: ["CRB 132"], errata: false, feature: "You can drink this blood to disappear from where you are and immediately reappear at a point you can see within <a href='#define-range'>Very Far</a> range." },
{ label: "Homet's Secret Potion", name: "homets-secret-potion", pages: ["CRB 132"], errata: false, feature: "After drinking this potion, the next successful <a href='#define-attack-roll'>attack</a> you make <a href='#define-damage-roll'>critically succeeds</a>." },
{ label: "Redthorn Saliva", name: "redthorn-saliva", pages: ["CRB 132"], errata: false, feature: "You can apply this saliva to a <a href='#define-weapon'>weapon</a> that deals <a href='#define-damage-type'>physical damage</a> to add a <strong>d12</strong> to your next <a href='#define-damage-roll'>damage roll</a> with that weapon." },
{ label: "Channelstone", name: "channelstone", pages: ["CRB 132"], errata: false, feature: "You can use this stone to take a spell or grimoire from your <a href='#define-loadout'>vault</a>, use it once, and return it to your <a href='#define-loadout'>vault</a>." },
{ label: "Mythic Dust", name: "mythic-dust", pages: ["CRB 133"], errata: false, feature: "You can apply this dust to a <a href='#define-weapon'>weapon</a> that deals <a href='#define-damage-type'>magic damage</a> to add a <strong>d12</strong> to your next <a href='#define-damage-roll'>damage roll</a> with that weapon." },
{ label: "Acidpaste", name: "acidpaste", pages: ["CRB 133"], errata: false, feature: "This paste eats away walls and other surfaces in bright flashes." },
{ label: "Hopehold Flare", name: "hopehold-flare", pages: ["CRB 133"], errata: false, feature: "When you use this flare, allies within <a href='#define-range'>Close</a> range roll a <strong>d6</strong> when they <strong><a href='#define-hope'>spend a Hope</a></strong>. On a result of 6, they gain the effect of that <a href='#define-hope'>Hope</a> without spending it. The flare lasts until the end of the scene." },
{ label: "Major Arcane Shard", name: "major-arcane-shard", pages: ["CRB 133"], errata: false, feature: "You can make a <a href='#define-trait-roll'>Finesse Roll</a> to throw this shard at a group of adversaries within <a href='#define-range'>Far</a> range. Targets you succeed against take <strong>4d20</strong> <a href='#define-damage-type'>magic damage</a>." },
{ label: "Featherbone", name: "featherbone", pages: ["CRB 133"], errata: false, feature: "You can use this bone to control your falling speed for a number of minutes equal to your <a href='#define-level'>level</a>." },
{ label: "Circle of the Void", name: "circle-of-the-void", pages: ["CRB 133"], errata: false, feature: "<strong><a href='#define-stress'>Mark a Stress</a></strong> to create a void that extends up to <a href='#define-range'>Far</a> range. No magic can be cast inside the void, and creatures within the void are <a href='#define-damage-type'>immune</a> to <a href='#define-damage-type'>magic damage</a>." },
{ label: "Sun Tree Sap", name: "sun-tree-sap", pages: ["CRB 133"], errata: false, feature: "Consume this sap to roll a <strong>d6</strong>. On a result of 5&ndash;6, clear 2 <a href='#define-hit-point'>Hit Points</a>. On a result of 2&ndash;4, clear 3 <a href='#define-stress'>Stress</a>. On a result of 1, see through the veil of death and return unscathed, gaining one scar." },
{ label: "Dripfang Poison", name: "dripfang-poison", pages: ["CRB 133"], errata: false, feature: "A creature who consumes this poison takes <strong>2d10</strong> <a href='#define-damage-type'>direct magic damage</a>." },
{ label: "Major Health Potion", name: "major-health-potion", pages: ["CRB 133"], errata: false, feature: "Clear <strong>1d4+2</strong> <a href='#define-hit-point'>Hit Points</a>." },
{ label: "Major Stamina Potion", name: "major-stamina-potion", pages: ["CRB 133"], errata: false, feature: "Clear <strong>1d4+2</strong> <a href='#define-stress'>Stress</a>." },
{ label: "Ogre Musk", name: "ogre-musk", pages: ["CRB 133"], errata: false, feature: "You can use this musk to prevent anyone from tracking you by mundane or magical means until your next <a href='#define-downtime'>rest</a>." },
{ label: "Wingsprout", name: "wingsprout", pages: ["CRB 133"], errata: false, feature: "You gain magic wings that allow you to fly for a number of minutes equal to your <a href='#define-level'>level</a>." },
{ label: "Jar of Lost Voices", name: "jar-of-lost-voices", pages: ["CRB 133"], errata: false, feature: "You can open this jar to release a deafening echo of voices for a number of minutes equal to your <a href='#define-instinct'>Instinct</a>. Creatures within <a href='#define-range'>Far</a> range unprepared for the sound take <strong>6d8</strong> <a href='#define-damage-type'>magic damage</a>." },
{ label: "Dragonbloom Tea", name: "dragonbloom-tea", pages: ["CRB 133"], errata: false, feature: "You can drink this tea to unleash a fiery breath attack. Make an <strong><a href='#define-trait-roll'>Instinct Roll</a></strong> against all adversaries in front of you within <a href='#define-range'>Close</a> range. Targets you succeed against take <strong>2d20</strong> <a href='#define-damage-type'>physical damage</a> using your Proficiency." },
{ label: "Bridge Seed", name: "bridge-seed", pages: ["CRB 133"], errata: false, feature: "Thick vines grow from your location to a point of your choice within <a href='#define-range'>Far</a> range, allowing you to climb up or across them. The vines dissipate on your next <a href='#define-downtime'>short rest</a>." },
{ label: "Sleeping Sap", name: "sleeping-sap", pages: ["CRB 133"], errata: false, feature: "You can drink this potion to fall asleep for a full night's rest. You clear all <a href='#define-stress'>Stress</a> upon waking." },
{ label: "Feast of Xuria", name: "feast-of-xuria", pages: ["CRB 133"], errata: false, feature: "You can eat this meal to clear all <a href='#define-hit-point'>Hit Points</a> and <a href='#define-stress'>Stress</a> and gain <strong>1d4</strong> <a href='#define-hope'>Hope</a>." },
{ label: "Bonding Honey", name: "bonding-honey", pages: ["CRB 133"], errata: false, feature: "This honey can be used to glue two objects together permanently." },
{ label: "Shrinking Potion", name: "shrinking-potion", pages: ["CRB 133"], errata: false, feature: "You can drink this potion to halve your size until you choose to drop this form or your next <a href='#define-downtime'>rest</a>. While in this form, you have a +2 bonus to <a href='#define-agility'>Agility</a> and a &ndash;1 penalty to your Proficiency." },
{ label: "Growing Potion", name: "growing-potion", pages: ["CRB 133"], errata: false, feature: "You can drink this potion to double your size until you choose to drop this form or your next <a href='#define-downtime'>rest</a>. While in this form, you have a +2 bonus to <a href='#define-strength'>Strength</a> and a +1 bonus to your <a href='#define-damage-roll'>Proficiency</a>." },
{ label: "Knowledge Stone", name: "knowledge-stone", pages: ["CRB 133"], errata: false, feature: "If you die while holding this stone, an ally can take a card from your loadout to place in their <a href='#define-loadout'>loadout or vault</a>. After they take this knowledge, the stone crumbles." },
{ label: "Sweet Moss", name: "sweet-moss", pages: ["CRB 133"], errata: true, feature: "You can consume this moss during a rest to clear <strong>1d10</strong> <a href='#define-hit-point'>Hit Points</a> or <strong>1d10</strong> <a href='#define-stress'>Stress</a>." },
{ label: "Blinding Orb", name: "blinding-orb", pages: ["CRB 133"], errata: false, feature: "You can activate this orb to create a flash of bright light. All targets within <a href='#define-range'>Close</a> range become <a href='#define-condition'><em>Vulnerable</em></a> until they mark <a href='#define-hit-point'>Hit Points</a>." },
{ label: "Death Tea", name: "death-tea", pages: ["CRB 133"], errata: false, feature: "After you drink this tea, you instantly kill your target when you <a href='#define-damage-roll'>critically succeed</a> on an <a href='#define-attack-roll'>attack</a>. If you don't critically succeed on an attack before your next <a href='#define-downtime'>long rest</a>, you die." },
{ label: "Mirror of Marigold", name: "mirror-of-marigold", pages: ["CRB 133"], errata: false, feature: "When you take <a href='#define-hit-point'>damage</a>, you can <strong><a href='#define-hope'>spend a Hope</a></strong> to negate that damage, after which the mirror shatters." },
{ label: "Stardrop", name: "stardrop", pages: ["CRB 133"], errata: false, feature: "You can use this stardrop to summon a hailstorm of comets that deals <strong>8d20</strong> <a href='#define-damage-type'>physical damage</a> to all targets within <a href='#define-range'>Very Far</a> range." }
];
const goldList = [
...
function printCC() {
	...
	CC += getReferences(["CRB 13", "Editorial Addition"]);
	...
	CC += "<li class='list-inline-item'><a href='pdfs/old-gus-daggerheart-quick-reference.pdf' class='btn mt-1 mb-1 theme-light border'><span aria-hidden='true' class='fw-bold'>&#x21e9;&nbsp;</span>Player Quick-Reference</a></li>";
	CC += "</ul>";
...
function printClasses() {
	...
	classContent += getReferences(["CRB 27"]);
	...
	for (let i = 0; i < classesList.length; i++) {
		...
		if (classesList[i].label == "Druid") {
			...
			// beastform info
			classRecord += "</ul></div>";
			classRecord += getReferences(["CRB 32"]);
			...
			classRecord += getReferences(["CRB 40", "Errata", "Editorial Addition"]);
			...
			classRecord += getReferences(["CRB 40"]);
...
function printDomains() {
	...
	domainContent += getReferences(["CRB 24"]);
	...
	domainContent += getReferences(["CRB 26"]);
	...
	domainContent += getReferences(["CRB 101", "CRB 107"]);
	domainContent += "<dl>";
...
function printAncestries() {
	...
	ancestryContent += getReferences(["CRB 52"]);
	...
	ancestryContent += getReferences(["CRB 71"]);
...
function printCommunities() {
	...
	communityContent += getReferences(["CRB 72"]);
...
function printTraits() {
	...
	traitContent += getReferences(["CRB 17"]);
...
function printEquipment() {
	...
	iEquip += getReferences(["CRB 112", "CRB 115", "Errata"]);
	...
	iWep += getReferences(["CRB 96", "CRB 112", "CRB 113", "Errata"]);
	iWep += "<dl>";
	...
	iWep += getReferences(["CRB 122", "CRB 123"]);
	...
	iArm += getReferences(["CRB 112", "CRB 114", "Errata"]);
	iArm += "<dl>";
	...
	for (let t = 1; t < 5; t++) {
		...
		// continue
		let armorPage = "";
		if (t == 1) { armorPage = "CRB 126"; }
		else if (t == 2) { armorPage = "CRB 126"; }
		else if (t == 3) { armorPage = "CRB 127"; }
		else if (t == 4) { armorPage = "CRB 127"; }
	...
	lootTable += getReferences(["CRB 129"]);
	...
	consumableTable += getReferences(["CRB 132"]);
	...
	iLoot += getReferences(["CRB 104", "CRB 165"]);
...
function printWeaponPrimaryTable(weaponTier, weaponType) {
	...
	if (weaponTier == 1 && weaponType == false) {
		weaponPage = ["CRB 115", "CRB 123", "Errata"];
		weaponErrata = true;
	}
...
function printRanges() {
	...
	iRange += getReferences(["CRB 103", "CRB 104"]);
...
function printDifficultyBenchmarks() {
	...
	dBench += getReferences(["CRB 157", "Editorial Addition"]);
